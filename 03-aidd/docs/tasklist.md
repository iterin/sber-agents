...
| 2 | Ответы от LLM (базово) | ⏳ | 0% | Без контекста |
...
- [ ] Подключить LLM-клиент (OpenAI/OpenRouter) с системным промптом
- [ ] Текстовое сообщение → один ответ от модели
- [ ] Тест: отправить фразу, получить осмысленный ответ (моки при отсутствии ключа)
