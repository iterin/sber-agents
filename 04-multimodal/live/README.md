...
- ✅ Локальная транскрибация голосовых сообщений (Vosk)
...
- [FFmpeg](https://ffmpeg.org/download.html) — конвертация голосовых сообщений (OGG → WAV)

> **Windows:** можно установить через [Chocolatey](https://chocolatey.org/) (`choco install ffmpeg`),  
> **macOS:** `brew install ffmpeg`,  
> **Linux:** `sudo apt install ffmpeg` (или соответствующий пакет).
...
**Параметры локальной транскрибации (Vosk):**
```bash
VOSK_MODEL_PATH=models/vosk-ru-small    # путь к распакованной Vosk модели
```
...
- Отправка голосового сообщения — бот расшифрует аудио локально (Vosk) и обработает как обычный текст
